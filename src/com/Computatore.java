...
public class Computatore {
	...
	public static void main(String[] args) throws Exception {
		...
		while (programmaOn == true) {
			...
			case 1:
				continuo = true;
				System.out.println("Hai scelto l'opzione 1 che ti consente di verificare se un numero e pari o dispari");
			...
			case 2:
				...
				do {
					System.out.println("Inserisci due numeri e verifica se sono uguali oppure quali dei due e maggiore");
			...
			case 3:
				continuo = true;
				System.out.println("Hai scelto l'opzione 3 che ti consente di contare fino a un numero a tua scelta");
			...
			case 4:
				continuo = true;
				System.out.println("Hai scelto l'opzione 4 che ti consente di contare fino a un numero a tua scelta e visualizzarlo in orizzontale");

				do {
					System.out.println("Inserisci il numero fino al quale desidiri contare...");
					int numeroInEntrata = input.nextInt();
					nuovoController.conatoreOrizzontale(numeroInEntrata);
					System.out.println(
							"Vuoi contare ancora ? inserisci S se vuoi proseguire oppure N se vuoi tornare al menu principale");
					String vuoiContinuare = input.next();
			...
			case 6:
				continuo = true;
				System.out.println("Hai scelto l'opzione 6 che ti consente di trovare il totale e la media di una lista di numeri a scelta");
			...
			case 8:
				continuo = true;
				System.out.println("Hai scelto l'opzione 8 che ti consente di creare un vettore di 10 nominativi e visualizzarlo");
			...
			case 9:
				continuo = true;
				System.out.println("Hai scelto l'opzione 9 che ti consente di creare un vettore di 10 nominativi e ordinarlo in ordine alfabetico");
			...
			case 11:
				continuo = true;
				System.out.println("Hai scelto l'opzione 11 che ti consente di stampare la tabellina di un numero a scelta");
			...
			case 12:
				continuo = true;
				System.out.println("Hai scelto l'opzione 12 che ti consente di stampare le temperature della settimana");
